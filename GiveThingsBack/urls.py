...
urlpatterns = [
                  ...
                  path('form/2', app.views.GiveawayForm_2.as_view(), name='form2'),
                  path('form/3', app.views.GiveawayForm_3.as_view(), name='form3'),
                  path('form/4', app.views.GiveawayForm_4.as_view(), name='form4'),
                  path('form/5', app.views.GiveawayForm_5.as_view(), name='form5'),
                  path('form/6', app.views.GiveawayForm_6.as_view(), name='form6'),
